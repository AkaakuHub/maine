		...
		<div className="p-4 lg:p-6">
			...
			<div className="space-y-3 lg:space-y-3">
				{Array.from({ length: videoCount }, (_, i) => (
					...
					>
						<div
							className={`${thumbnailSize} bg-gradient-to-br from-purple-600/20 to-blue-600/20 rounded-lg flex-shrink-0 flex items-center justify-center border border-purple-500/20 group-hover:border-purple-400/40 transition-colors`}
						>
							<Play
