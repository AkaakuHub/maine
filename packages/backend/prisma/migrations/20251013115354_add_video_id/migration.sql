/*
  ...
  - You are about to drop the `chapter_skip_rules` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `scan_schedule_settings` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `scan_settings` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `user_settings` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "chapter_skip_rules";
PRAGMA foreign_keys=on;

-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "scan_schedule_settings";
PRAGMA foreign_keys=on;
